...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background">
        ...
        {!hasData && (
          ...
          >
            <div className="rounded-2xl border-2 border-dashed border-border/60 bg-gradient-to-br from-card via-card/98 to-card/95 p-10 text-center shadow-lg hover:shadow-xl hover:border-primary/40 transition-all duration-500 card-glass">
              ...
              <h3 className="text-xl font-bold mb-3 bg-gradient-to-r from-foreground to-foreground/85 bg-clip-text text-transparent">
        ...
        {isLoading && (
          <div className="mt-16">
            <div className="mb-10 text-center animate-fade-slide-up">
              <div className="inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-primary/12 via-primary/15 to-primary/12 px-8 py-4 text-primary shadow-lg backdrop-blur-sm border border-primary/25">
            ...
            <div className="grid gap-6 grid-cols-[repeat(auto-fit,minmax(260px,1fr))]">
              {[1, 2, 3].map((i) => (
                <div key={i} className="group">
                  <div className="h-80 rounded-2xl bg-gradient-to-br from-card to-card/60 border border-border/50 shadow-lg relative overflow-hidden">
                    <div className="absolute inset-0 animate-shimmer"></div>
                  </div>
                  <div className="mt-4 space-y-2">
                    <div className="h-5 rounded-lg bg-muted/50 skeleton w-3/4"></div>
      ...
      {/* Footer */}
      <footer className="border-t border-border/50 bg-gradient-to-b from-card/50 to-card/30 backdrop-blur-sm mt-24">
        <div className="app-container py-10">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span className="font-semibold">© 2025 Atlas Inovações</span>
              <span className="text-border">•</span>
              <span className="font-medium">Precificação Inteligente</span>
            </div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
